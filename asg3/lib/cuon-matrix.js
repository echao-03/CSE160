...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let output1 = +other1.elements[0] * +other2.elements[0];
        let output2 = +other1.elements[1] * +other2.elements[1];
        let output3 = +other1.elements[2] * +other2.elements[2];
    ...
    static cross(other1, other2) {
        ...
        let output1 = (+other1.elements[1] * +other2.elements[2]) - (+other1.elements[2] * +other2.elements[1]);
        let output2 = (+other1.elements[2] * +other2.elements[0]) - (+other1.elements[0] * +other2.elements[2]);
        let output3 = (+other1.elements[0] * +other2.elements[1]) - (+other1.elements[1] * +other2.elements[0]);

        v3.elements[0] = output1;
        v3.elements[1] = output2;
        v3.elements[2] = output3;
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        ...
        let var1 = Math.pow(this.elements[0], 2);
        let var2 = Math.pow(this.elements[1], 2);
        let var3 = Math.pow(this.elements[2], 2);
        m = Math.sqrt(+var1 + +var2 + +var3);
        // Don't delete the return statement.
        return m;
    };
